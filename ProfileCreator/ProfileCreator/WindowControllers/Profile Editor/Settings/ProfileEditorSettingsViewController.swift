...
class ProfileEditorSettigsView: NSView {
    ...
    init(profile: Profile) {
        ...
        lastSubview = addCheckbox(label: "Disable Optional Keys",
                                  title: "",
                                  bindTo: profile,
                                  bindKeyPath: profile.editorDisableOptionalKeysSelector,
                                  toView: self,
        ...
        lastSubview = addPopUpButton(label: "Distribution:",
                                     ...
                                     bindTo: profile,
                                     bindKeyPath: profile.editorDistributionMethodSelector,
                                     toView: self,
                                     lastSubview: lastSubview,
        ...
        lastSubview = addCheckbox(label: "Show Editor Rows",
                                  ...
                                  bindTo: profile,
                                  bindKeyPath: profile.editorColumnEnableSelector,
                                  toView: self,
                                  lastSubview: lastSubview,
        ...
        lastSubview = addCheckbox(label: "Show Payload Keys",
                                  title: "Hidden",
                                  bindTo: profile,
                                  bindKeyPath: profile.editorShowHiddenSelector,
                                  toView: self,
                                  lastSubview: lastSubview,
                                  lastTextField: lastSubview,
                                  height: &frameHeight,
        ...
        lastSubview = addCheckbox(label: nil,
                                  title: "Disabled",
                                  bindTo: profile,
                                  bindKeyPath: profile.editorShowDisabledSelector,
                                  toView: self,
                                  lastSubview: lastSubview,
                                  lastTextField: lastSubview,
                                  height: &frameHeight,
        ...
        lastSubview = addCheckbox(label: nil,
                                  title: "Supervised",
                                  bindTo: profile,
                                  bindKeyPath: profile.editorShowSupervisedSelector,
                                  toView: self,
                                  lastSubview: lastSubview,
                                  lastTextField: lastSubview,
                                  height: &frameHeight,
        ...
        lastSubview = addCheckbox(label: "Show Platform",
                                  title: "iOS",
                                  bindTo: profile,
                                  bindKeyPath: profile.editorShowIOSSelector,
                                  toView: self,
                                  lastSubview: lastSubview,
                                  lastTextField: lastSubview,
                                  height: &frameHeight,
        ...
        lastSubview = addCheckbox(label: nil,
                                  title: "macOS",
                                  bindTo: profile,
                                  bindKeyPath: profile.editorShowMacOSSelector,
                                  toView: self,
                                  lastSubview: lastSubview,
                                  lastTextField: lastSubview,
                                  height: &frameHeight,
        ...
        lastSubview = addCheckbox(label: nil,
                                  title: "tvOS",
                                  bindTo: profile,
                                  bindKeyPath: profile.editorShowTvOSSelector,
                                  toView: self,
                                  lastSubview: lastSubview,
                                  lastTextField: lastSubview,
                                  height: &frameHeight,
        ...
        lastSubview = addCheckbox(label: "Show Scope",
                                  title: "User",
                                  bindTo: profile,
                                  bindKeyPath: profile.editorShowScopeUserSelector,
                                  toView: self,
                                  lastSubview: lastSubview,
                                  lastTextField: lastSubview,
                                  height: &frameHeight,
        ...
        lastSubview = addCheckbox(label: nil,
                                  title: "System",
                                  bindTo: profile,
                                  bindKeyPath: profile.editorShowScopeSystemSelector,
                                  toView: self,
                                  lastSubview: lastSubview,
                                  lastTextField: lastSubview,
                                  height: &frameHeight,
