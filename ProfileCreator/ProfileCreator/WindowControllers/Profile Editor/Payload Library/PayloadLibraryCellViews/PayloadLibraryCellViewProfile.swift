...
class PayloadLibraryCellViewProfile: NSTableCellView, PayloadLibraryCellView {
    ...
    init(payloadPlaceholder: PayloadPlaceholder) {
        ...
        // ---------------------------------------------------------------------
        self.imageViewIcon = LibraryImageView.icon(image: NSImage(named: NSImageNamePreferencesGeneral), width: 31.0, indent: 4.0, constraints: &constraints, cellView: self)
        self.buttonToggle = LibraryButton.toggle(image: NSImage(named: NSImageNameRemoveTemplate), width: 14.0, indent: 5.0, constraints: &constraints, cellView: self)
        self.textFieldTitle = LibraryTextField.title(string: payloadPlaceholder.title, fontSize: 12, fontWeight: NSFontWeightBold, indent: 6.0, constraints: &constraints, cellView: self)
