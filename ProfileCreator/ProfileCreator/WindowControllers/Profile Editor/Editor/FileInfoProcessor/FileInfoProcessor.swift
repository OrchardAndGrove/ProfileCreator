...
class FileInfoProcessor {
    ...
    var fileAttributes: Dictionary<FileAttributeKey, Any>?
    ...
    init?(data: Data, fileInfo: Dictionary<String, Any>) {
    ...
    func fileInfoDict() -> Dictionary<String, Any> {
        var fileInfoDict = Dictionary<String, Any>()
