...
class ProfileEditorTab: NSView {
    ...
    let borderRight = NSBox(frame: NSRect(x: 250.0, y: 15.0, width: preferencesWindowWidth - (20.0 * 2), height: 250.0))
    ...
    let colorDeSelected = NSColor.black.withAlphaComponent(0.08)
    let colorDeSelectedMouseOver = NSColor.black.withAlphaComponent(0.14)
