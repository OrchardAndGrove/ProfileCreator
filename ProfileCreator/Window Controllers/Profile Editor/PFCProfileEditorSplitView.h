...
@class PFCProfileEditorTableViewController;

@interface PFCProfileEditorSplitView : NSSplitView
...
@property (nonatomic, strong, readonly, nonnull) PFCProfileEditorLibrarySplitView *librarySplitView;
@property (nonatomic, strong, readonly, nonnull) PFCProfileEditorTableViewController *tableViewController;
