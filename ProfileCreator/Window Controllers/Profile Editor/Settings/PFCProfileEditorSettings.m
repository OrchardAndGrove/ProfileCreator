...
@property (nonatomic, readwrite, strong, nonnull) PFCProfileEditorSettingsView *settingsView;
...
- (nonnull instancetype)initWithProfile:(PFCProfile *_Nonnull)profile {
    ...
    if (self != nil) {
        ...
        // ---------------------------------------------------------------------
        _profile = profile;
        _settingsView = [[PFCProfileEditorSettingsView alloc] initWithProfile:_profile];
    }
    return self;
}
